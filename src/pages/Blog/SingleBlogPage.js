...
function SingleBlogPage() {
  return (
    <div>
      <NavBar />
      <div className="grid place-items-center mx-2 md:w-1/2 md:m-auto">
        <div className=" font-extrabold  text-2xl mb-4">Title</div>
        <img src={blogimage} alt="blogimage" className=" h-44 w-full md:h-80" />
        ...
        <div className="font-extrabold text-xl mb-4">subtitle</div>
